...
//int totalSum;
//int xboard[4] = { 0, -1, 0, 1 };
//int yboard[4] = { -1, -0, 1, 0 };
//
//
//int sumOfarray() {
//	for (int i = 0; i < row; i++) {
...
//
//
//int line1(int starty, int startx) {
//	if (startx + 4 > col) {
//		return 0;
//	}
//	int horizonSum = 0;
//	for (int i = 0; i < 4; i++) {
//		horizonSum += board[starty][startx+i];
//	}
//	return totalSum - horizonSum;
//}
//int line2(int starty, int startx) {
//	if (starty + 4 > row) {
//		return 0;
//	}
//	int verticalSum = 0;
//	for (int i = 0; i < 4; i++) {
//		verticalSum += board[starty+i][startx];
//	}
//	return totalSum - verticalSum;
//}
//
//void input() {
//	cin >> row >> col;
